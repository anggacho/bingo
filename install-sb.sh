...
bash install-sb.sh
echo -e "Sudah siap geng [$green✓$nc] $nc "
sleep 1
clear
#Startup
echo -e "$green"
...
echo -e "	[+]              $red Coded By CHOADDICT$nc         		   [+]"
echo -e "	[+] 		 $red www.facebook.com/anggacho99$nc 		   [+]"
echo -e "	[+] 		 $red  Pentesters$nc          		   [+]"
echo -e "	[+]$red Special Greetz To$nc :$green {CHOADDICT , Ha3MrX, Tunisian Eagles}$nc [+]"
echo ""
echo -e "$yellow Select From Menu : $nc"
echo ""
echo -e "		$Cyan 1 : \CHO Brute Force Akun Facebook$nc"
echo -e "		$Cyan 2 : \CHO Brute Force Akun Gmail$nc"
echo -e "		$Cyan 3 : \CHO Brute Force Akun Instagram$nc"
echo -e "		$Cyan 4 : \CHO Brute Force Akun Twitter$nc"
